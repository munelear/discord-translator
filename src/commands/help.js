...
const helpMessage = function(config, botname, param)
{
   ...
   helpSection({
      ...
      link: "https://github.com/munelear/discord-translator/wiki/Translate-with-Emoji-Reaction",
      icon: ":flag_white:",
      cmd: null,
      help: "react",
      args: null,
   ...
   helpSection({
      ...
      link: "https://github.com/munelear/discord-translator/wiki/Translate-Custom-Text",
      icon: ":abc:",
      cmd: "this",
      help: "custom",
   ...
   helpSection({
      ...
      link: "https://github.com/munelear/discord-translator/wiki/Translate-Last-Message",
   ...
   helpSection({
      ...
      link: "https://github.com/munelear/discord-translator/wiki/Translate-Channel-Automatic",
      icon: ":hash:",
      cmd: "channel",
      help: "auto",
   ...
   helpSection({
      config: config,
      title: "Stats",
      link: "https://github.com/munelear/discord-translator/wiki/Get-Statistics",
      icon: ":bar_chart:",
      cmd: "stats",
      help: "misc",
